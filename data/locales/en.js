(function () {
  ...
  window.PORTAL_TRANSLATIONS.en = {
    ...
    form: {
      ...
      noDocumentNumbers: "Your PESEL and passport number are not saved in the browser draft. After submission, the application goes only to the recruiter. Do not upload document photos.",
